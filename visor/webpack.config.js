...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
        ...
        datatables_js: __dirname + "/vendors/DataTables/datatables.js",
        datatables_css: __dirname + "/vendors/DataTables/datatables.css",
        pdfmake: __dirname + "/vendors/DataTables/pdfmake-0.1.36/pdfmake.js",
        vfs_fonts: __dirname + "/vendors/DataTables/pdfmake-0.1.36/vfs_fonts.js",
        jquery_ui_css: __dirname + "/vendors/jquery-ui-1.12.1.custom/jquery-ui.min.css",
        jquery_ui_theme_css: __dirname + "/vendors/jquery-ui-1.12.1.custom/jquery-ui.theme.min.css",
        jquery_ui_js: __dirname + "/vendors/jquery-ui-1.12.1.custom/jquery-ui.min.js",
