...
class DepartmentConfigApiController extends Controller
{
    ...
    public function getDepartmentConfig(Request $request, $department_code)
    {
        ...
        $camineria_wfs_url = env('CAMINERIA_WMS_URL', DepartmentConfigApiController::CAMINERIA_DEFAULT_WFS_URL);
        $camineria_wms_url = env('CAMINERIA_WFS_URL', DepartmentConfigApiController::CAMINERIA_DEFAULT_WMS_URL);
        // añadimos a piñón las capas de caminería
    ...
    public function getGlobalConfigStatic(Request $request)
    {
